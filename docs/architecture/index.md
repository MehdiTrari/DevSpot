...
Cette section rassemble les documents décrivant la structure technique de DevSpot.
...
- cartographie des modules métier Symfony,
- diagrammes de séquence sur les flux clés (authentification, matching, messagerie),
- stratégie de déploiement cible et observabilité applicative.
